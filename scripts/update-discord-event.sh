...
<dialog id="event">
    ...
    <p>There are currently no scheduled events. Please check back later or join our <a href=\"https://discord.gg/cqWcyCmFdb\" target="_blank">Discord</a> for updates.</p>
    <footer>
        <form method="dialog">
